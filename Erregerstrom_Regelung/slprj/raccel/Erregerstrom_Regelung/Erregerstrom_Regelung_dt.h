...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . l2yxtgd5ue ) , 0 , 0 , 25 } ,
{ ( char_T * ) ( & rtDW . ehy1wkofia ) , 0 , 0 , 12 } , { ( char_T * ) ( &
rtDW . mktnnal2dg ) , 11 , 0 , 16 } , { ( char_T * ) ( & rtDW . cm0cbljfgw [
0 ] ) , 10 , 0 , 5 } , { ( char_T * ) ( & rtDW . diguumcgnb ) , 8 , 0 , 4 } }
; static DataTypeTransitionTable rtBTransTable = { 5U , rtBTransitions } ;
static DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP .
I_Erregung_MAX ) , 0 , 0 , 24 } } ; static DataTypeTransitionTable
