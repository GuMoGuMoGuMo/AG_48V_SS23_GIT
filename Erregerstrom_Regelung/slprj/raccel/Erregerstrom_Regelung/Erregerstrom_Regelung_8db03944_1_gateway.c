...
#endif
#include "nesl_rtw.h"
#include "Erregerstrom_Regelung_8db03944_1.h"
#include "Erregerstrom_Regelung_8db03944_1_gateway.h"
void Erregerstrom_Regelung_8db03944_1_gateway ( void ) { NeModelParameters
modelparams = { ( NeSolverType ) 0 , 0.001 , 0.001 , 0.001 , 1 , 0 , (
NeModifyAbsTol ) 2 , 0.001 , 0 , 0 , 0 , 0 , ( SscLoggingSetting ) 0 ,
599674750 , 0 , } ; NeSolverParameters solverparams = { 0 , (
...
Erregerstrom_Regelung_8db03944_1_dae ( & dae , & modelparams , & solverparams
) ; nesl_register_simulator_group (
"Erregerstrom_Regelung/Solver Configuration_1" , 1 , & dae , & solverparams ,
