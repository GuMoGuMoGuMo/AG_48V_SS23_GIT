...
MODULES                 = Erregerstrom_Regelung_acc.c Erregerstrom_Regelung_acc_data.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/Erregerstrom_Regelung_acc.mexmaci64
...
NCSTATES                = 2
COMPUTER                = MACI64
BUILDARGS               =  OPTS="-DTID01EQ=0" MACOSX_VERSION_MIN_FLAG="-mmacosx-version-min=10.15"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ALLOCATIONFCN           = 0
...
SYSTEM_LIBS             = -L"/Applications/MATLAB_R2022b.app/bin/maci64" -lmwipp -lut -lmwmathutil -lmwsl_simtarget_instrumentation -lmwsl_simtarget_core -lmwsl_fileio -lmwsigstream -lmwslexec_simlog -lmwsl_AsyncioQueue -lmwsf_runtime -lmwsimulink -lmwslexec_simbridge -lmwstringutil -lemlrt -lmwslio_core -lmwslio_clients -lmwsl_services -lmx -lmex
...
MODELLIB                  = Erregerstrom_Regelung_acc.mexmaci64
MODELREF_LINK_LIBS        = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/Erregerstrom_Regelung \
...
Erregerstrom_Regelung_acc.o : $(START_DIR)/slprj/accel/Erregerstrom_Regelung/Erregerstrom_Regelung_acc.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/Erregerstrom_Regelung/Erregerstrom_Regelung_acc.c

Erregerstrom_Regelung_acc_data.o : $(START_DIR)/slprj/accel/Erregerstrom_Regelung/Erregerstrom_Regelung_acc_data.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/Erregerstrom_Regelung/Erregerstrom_Regelung_acc_data.c
